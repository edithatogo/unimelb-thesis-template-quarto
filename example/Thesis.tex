...
\usepackage{template/vector}  % Allows "\bvec{}" and "\buvec{}" for "blackboard" style bold vectors in maths
...
\department{Department of Modernisation}
\departmenturl{https://www.unimelb.edu.au/modernisation}
\school{School of Advanced Templates}
\schoolurl{https://www.unimelb.edu.au/templates}
\group{Gemini CLI Research Group}
\groupurl{https://www.gemini.com/research}
\subject{LaTeX Template Modernisation}
\keywords{LaTeX, Template, Modernisation, Gemini CLI}
...
\input{example/Preamble/Acknowledgements.tex}
...
\input{example/Chapters/Chapter1} % Introduction
...
\input{example/Appendices/AppendixA}	% Appendix Title
